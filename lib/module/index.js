...
import { NativeEventEmitter, NativeModules, AppRegistry, Platform } from 'react-native';
...
export const RNBackgroundGeofence = NativeModules.RNBackgroundGeofence ? NativeModules.RNBackgroundGeofence : new Proxy({}, {
  get() {
...
export const addGeofence = boundary => {
...
export const removeGeofence = id => {
